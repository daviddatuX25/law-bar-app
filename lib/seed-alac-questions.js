/**
 * lib/seed-alac-questions.js
 * Seeds high-quality, disguised bar-exam-style ALAC questions grounded
 * in actual flashcards from the database.
 *
 * This file is placed in lib/ because lib/ is copied into the production
 * Docker container (whereas scripts/ is omitted).
 */
...
async function seedAlacQuestions(db) {
  let created = 0;
  let skipped = 0;
...
module.exports = { seedAlacQuestions, QUESTIONS };
